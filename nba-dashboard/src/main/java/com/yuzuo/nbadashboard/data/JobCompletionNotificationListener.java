...
//    use entity manager to interact with the db
    ...
    public void afterJob(JobExecution jobExecution) {
        if(jobExecution.getStatus() == BatchStatus.COMPLETED) {
            ...
            entityManager.createQuery("select m.homeTeam, count(*) from Match m where m.homeTeamWins = 1 or m.homeTeamWins = 0 group by m.homeTeam", Object[].class)
                    .getResultList()
                    .stream()
                    .forEach(e -> {
                        Team team = teamData.get((String) e[0]);
